...
namespace OglasiSource.Infrastructure.Data.Migrations
{
    ...
    [Migration("20230414090724_Initial_Migrations")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OglasiSource.Core.Entities.Comment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("EntityTypeCommentId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("EntityTypeCommentId");

                    b.ToTable("Comment");
                });

            modelBuilder.Entity("OglasiSource.Core.Entities.EntityTypeComment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("OglasiSource.Core.Entities.Comment", b =>
                {
                    ...
                    b.HasOne("OglasiSource.Core.Entities.EntityTypeComment", "EntityTypeComment")
                        .WithMany()
                        .HasForeignKey("EntityTypeCommentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("ApplicationUser");

                    b.Navigation("EntityTypeComment");
                });
