...
namespace MyPersonalTrainer.Api.Cqrs.Commands.Account
{
    public class SignAdminAccountCommand : IRequest<SignupVerifyResponse>
    {
        ...
        public class SignAccountCommandValidator : AbstractValidator<SignAdminAccountCommand>
        {
